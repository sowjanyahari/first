...
@Component({
  selector: 'app-medium-priority-graph',
  templateUrl: './medium-priority-graph.component.html',
  styleUrls: ['./medium-priority-graph.component.css']
})
...
gotopage()
{
  ...
  this.router.navigate(['/driver-priority/mediumprioritylist']);
}
